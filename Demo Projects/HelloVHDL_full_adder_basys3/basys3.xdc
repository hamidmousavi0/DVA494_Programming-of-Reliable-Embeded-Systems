...
## Clock signal (unused for full_adder) -- keep commented
# set_property PACKAGE_PIN W5 [get_ports clk]							
# 	set_property IOSTANDARD LVCMOS33 [get_ports clk]
# 	create_clock -add -name sys_clk_pin -period 10.00 -waveform {0 5} [get_ports clk]
 
## Switches (use SW0, SW1, SW2 for a, b, cin)
...
## LEDs (use LED0 for sum, LED1 for cout)
...
## 7-segment display and anodes (unused) -- keep commented
